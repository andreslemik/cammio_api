  ...
  class DashboardApi
    ...
    def get_stats_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: DashboardApi.get_stats ...'
      end
      # resource path
      ...
      # return_type
      return_type = opts[:return_type] || 'Stats' 
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: DashboardApi#get_stats\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
