...
module CammioAPI
  class InvitationsApi
    ...
    # @param invitation_id [Integer] Invitation id to delete
    # @param [Hash] opts the optional parameters
    # @return [nil]
    def delete_invitation(invitation_id, opts = {})
      delete_invitation_with_http_info(invitation_id, opts)
      nil
    end
    ...
    def delete_invitation_with_http_info(invitation_id, opts = {})
      if @api_client.config.debugging
      ...
      # resource path
      local_var_path = '/invitations/{invitationId}'.sub('{' + 'invitationId' + '}', CGI.escape(invitation_id.to_s))
    ...
    # @param invitation_id [Integer] ID of invitation to return
    # @param [Hash] opts the optional parameters
    # @return [Invitation]
    def get_invitation_by_id(invitation_id, opts = {})
      data, _status_code, _headers = get_invitation_by_id_with_http_info(invitation_id, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(Invitation, Integer, Hash)>] Invitation data, response status code and response headers
    def get_invitation_by_id_with_http_info(invitation_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: InvitationsApi.get_invitation_by_id ...'
      end
      # verify the required parameter 'invitation_id' is set
      if @api_client.config.client_side_validation && invitation_id.nil?
        fail ArgumentError, "Missing the required parameter 'invitation_id' when calling InvitationsApi.get_invitation_by_id"
      end
      # resource path
      local_var_path = '/invitations/{invitationId}'.sub('{' + 'invitationId' + '}', CGI.escape(invitation_id.to_s))
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: InvitationsApi#get_invitation_by_id\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def get_invitations_with_http_info(opts = {})
      ...
      if @api_client.config.client_side_validation && !opts[:'offset'].nil? && opts[:'offset'] < 0
        fail ArgumentError, 'invalid value for "opts[:"offset"]" when calling InvitationsApi.get_invitations, must be greater than or equal to 0.'
      end

      if @api_client.config.client_side_validation && !opts[:'limit'].nil? && opts[:'limit'] > 50
        fail ArgumentError, 'invalid value for "opts[:"limit"]" when calling InvitationsApi.get_invitations, must be smaller than or equal to 50.'
      end

      if @api_client.config.client_side_validation && !opts[:'limit'].nil? && opts[:'limit'] < 1
        fail ArgumentError, 'invalid value for "opts[:"limit"]" when calling InvitationsApi.get_invitations, must be greater than or equal to 1.'
      end
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: InvitationsApi#get_invitations\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
