...
module CammioAPI
  class InvitationsCallbackParams
    attr_accessor :my_custom_param

    attr_accessor :my_other_param
    ...
    def self.openapi_types
      {
        :'my_custom_param' => :'String',
        :'my_other_param' => :'String'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `CammioAPI::InvitationsCallbackParams` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `CammioAPI::InvitationsCallbackParams`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'my_custom_param')
        self.my_custom_param = attributes[:'my_custom_param']
      end

      if attributes.key?(:'my_other_param')
        self.my_other_param = attributes[:'my_other_param']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          my_custom_param == o.my_custom_param &&
          my_other_param == o.my_other_param
    end
    ...
    def hash
      [my_custom_param, my_other_param].hash
    end
