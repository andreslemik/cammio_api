...
module CammioAPI
  class ProfileExtraversionFacets
    attr_accessor :energetic

    attr_accessor :assertiveness

    attr_accessor :cheerfulness

    attr_accessor :excitement_seeking

    attr_accessor :friendliness

    attr_accessor :gregariousness
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `CammioAPI::ProfileExtraversionFacets` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `CammioAPI::ProfileExtraversionFacets`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'energetic')
        self.energetic = attributes[:'energetic']
      end

      if attributes.key?(:'assertiveness')
        self.assertiveness = attributes[:'assertiveness']
      end

      if attributes.key?(:'cheerfulness')
        self.cheerfulness = attributes[:'cheerfulness']
      end

      if attributes.key?(:'excitement_seeking')
        self.excitement_seeking = attributes[:'excitement_seeking']
      end

      if attributes.key?(:'friendliness')
        self.friendliness = attributes[:'friendliness']
      end

      if attributes.key?(:'gregariousness')
        self.gregariousness = attributes[:'gregariousness']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          energetic == o.energetic &&
          assertiveness == o.assertiveness &&
          cheerfulness == o.cheerfulness &&
          excitement_seeking == o.excitement_seeking &&
          friendliness == o.friendliness &&
          gregariousness == o.gregariousness
    end
    ...
    def hash
      [energetic, assertiveness, cheerfulness, excitement_seeking, friendliness, gregariousness].hash
    end
