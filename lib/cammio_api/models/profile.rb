...
module CammioAPI
  ...
  class Profile
    attr_accessor :agreeableness

    attr_accessor :conscientiousness

    attr_accessor :extraversion

    attr_accessor :neuroticism
    ...
    def self.openapi_types
      {
        :'agreeableness' => :'ProfileAgreeableness',
        :'conscientiousness' => :'ProfileConscientiousness',
        :'extraversion' => :'ProfileExtraversion',
        :'neuroticism' => :'ProfileNeuroticism',
        :'openness' => :'ProfileOpenness'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `CammioAPI::Profile` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `CammioAPI::Profile`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'agreeableness')
        self.agreeableness = attributes[:'agreeableness']
      end

      if attributes.key?(:'conscientiousness')
        self.conscientiousness = attributes[:'conscientiousness']
      end

      if attributes.key?(:'extraversion')
        self.extraversion = attributes[:'extraversion']
      end

      if attributes.key?(:'neuroticism')
        self.neuroticism = attributes[:'neuroticism']
      end

      if attributes.key?(:'openness')
        self.openness = attributes[:'openness']
      end
    end
    ...
    def hash
      [agreeableness, conscientiousness, extraversion, neuroticism, openness].hash
    end
