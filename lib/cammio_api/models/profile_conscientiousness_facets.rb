...
module CammioAPI
  class ProfileConscientiousnessFacets
    attr_accessor :driven

    attr_accessor :cautiousness

    attr_accessor :dutifullness

    attr_accessor :orderliness

    attr_accessor :self_discipline

    attr_accessor :self_efficacy
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `CammioAPI::ProfileConscientiousnessFacets` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `CammioAPI::ProfileConscientiousnessFacets`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'driven')
        self.driven = attributes[:'driven']
      end

      if attributes.key?(:'cautiousness')
        self.cautiousness = attributes[:'cautiousness']
      end

      if attributes.key?(:'dutifullness')
        self.dutifullness = attributes[:'dutifullness']
      end

      if attributes.key?(:'orderliness')
        self.orderliness = attributes[:'orderliness']
      end

      if attributes.key?(:'self_discipline')
        self.self_discipline = attributes[:'self_discipline']
      end

      if attributes.key?(:'self_efficacy')
        self.self_efficacy = attributes[:'self_efficacy']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          driven == o.driven &&
          cautiousness == o.cautiousness &&
          dutifullness == o.dutifullness &&
          orderliness == o.orderliness &&
          self_discipline == o.self_discipline &&
          self_efficacy == o.self_efficacy
    end
    ...
    def hash
      [driven, cautiousness, dutifullness, orderliness, self_discipline, self_efficacy].hash
    end
