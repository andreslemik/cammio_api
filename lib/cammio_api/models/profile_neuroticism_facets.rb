...
module CammioAPI
  class ProfileNeuroticismFacets
    attr_accessor :fiery

    attr_accessor :anxiety

    attr_accessor :melancholy

    attr_accessor :self_indulgence

    attr_accessor :self_consciousness

    attr_accessor :sensitivity_to_stress
    ...
    def self.attribute_map
      {
        ...
        :'self_indulgence' => :'self_indulgence',
        :'self_consciousness' => :'self_consciousness',
        :'sensitivity_to_stress' => :'sensitivity_to_stress'
      }
    end
    ...
    def self.openapi_types
      {
        ...
        :'anxiety' => :'Float',
        :'melancholy' => :'Float',
        :'self_indulgence' => :'Float',
        :'self_consciousness' => :'Float',
        :'sensitivity_to_stress' => :'Float'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `CammioAPI::ProfileNeuroticismFacets` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `CammioAPI::ProfileNeuroticismFacets`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'fiery')
        self.fiery = attributes[:'fiery']
      end

      if attributes.key?(:'anxiety')
        self.anxiety = attributes[:'anxiety']
      end

      if attributes.key?(:'melancholy')
        self.melancholy = attributes[:'melancholy']
      end

      if attributes.key?(:'self_indulgence')
        self.self_indulgence = attributes[:'self_indulgence']
      end

      if attributes.key?(:'self_consciousness')
        self.self_consciousness = attributes[:'self_consciousness']
      end

      if attributes.key?(:'sensitivity_to_stress')
        self.sensitivity_to_stress = attributes[:'sensitivity_to_stress']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          fiery == o.fiery &&
          anxiety == o.anxiety &&
          melancholy == o.melancholy &&
          self_indulgence == o.self_indulgence &&
          self_consciousness == o.self_consciousness &&
          sensitivity_to_stress == o.sensitivity_to_stress
    end
    ...
    def hash
      [fiery, anxiety, melancholy, self_indulgence, self_consciousness, sensitivity_to_stress].hash
    end
