...
module CammioAPI
  class StatsInterviews
    ...
    def self.openapi_types
      {
        :'candidates' => :'StatsInterviewsCandidates',
        :'reviewers' => :'StatsInterviewsReviewers',
        :'forwarded' => :'StatsInterviewsForwarded',
        :'averages' => :'StatsInterviewsAverages',
        :'feedback' => :'StatsInterviewsFeedback',
        :'platform' => :'StatsInterviewsPlatform'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `CammioAPI::StatsInterviews` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `CammioAPI::StatsInterviews`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'candidates')
        self.candidates = attributes[:'candidates']
      end

      if attributes.key?(:'reviewers')
        self.reviewers = attributes[:'reviewers']
      end
      ...
      if attributes.key?(:'averages')
        self.averages = attributes[:'averages']
      end
    ...
    def hash
      [candidates, reviewers, forwarded, averages, feedback, platform].hash
    end
