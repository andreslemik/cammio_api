...
module CammioAPI
  class ProfileAgreeablenessFacets
    attr_accessor :altruism

    attr_accessor :cooperation

    attr_accessor :modesty

    attr_accessor :morality

    attr_accessor :sympathy

    attr_accessor :trusting
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `CammioAPI::ProfileAgreeablenessFacets` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `CammioAPI::ProfileAgreeablenessFacets`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'altruism')
        self.altruism = attributes[:'altruism']
      end

      if attributes.key?(:'cooperation')
        self.cooperation = attributes[:'cooperation']
      end

      if attributes.key?(:'modesty')
        self.modesty = attributes[:'modesty']
      end

      if attributes.key?(:'morality')
        self.morality = attributes[:'morality']
      end

      if attributes.key?(:'sympathy')
        self.sympathy = attributes[:'sympathy']
      end

      if attributes.key?(:'trusting')
        self.trusting = attributes[:'trusting']
      end
    end
    ...
    def hash
      [altruism, cooperation, modesty, morality, sympathy, trusting].hash
    end
