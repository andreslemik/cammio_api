...
# Unit tests for CammioAPI::GuestsApi
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'GuestsApi' do
  before do
  ...
  describe 'test an instance of GuestsApi' do
    it 'should create an instance of GuestsApi' do
      expect(@api_instance).to be_instance_of(CammioAPI::GuestsApi)
    end
  end

  # unit tests for add_guest
  ...
  describe 'add_guest test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for get_guests
