...
# Unit tests for CammioAPI::QuestionsApi
...
describe 'QuestionsApi' do
  ...
  describe 'test an instance of QuestionsApi' do
    it 'should create an instance of QuestionsApi' do
      expect(@api_instance).to be_instance_of(CammioAPI::QuestionsApi)
    end
  end

  # unit tests for add_question
  ...
  # @param question_id Question id to delete
  # @param [Hash] opts the optional parameters
  # @return [nil]
  ...
  # @param question_id ID of question to return
  # @param [Hash] opts the optional parameters
  # @return [Question]
  ...
  # @param template_id Questions belonging to template
  # @param [Hash] opts the optional parameters
