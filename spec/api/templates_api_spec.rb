...
# Unit tests for CammioAPI::TemplatesApi
...
describe 'TemplatesApi' do
  ...
  describe 'test an instance of TemplatesApi' do
    it 'should create an instance of TemplatesApi' do
      expect(@api_instance).to be_instance_of(CammioAPI::TemplatesApi)
    end
  end
  ...
  # unit tests for get_template_interviews
  ...
  describe 'get_template_interviews test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for get_template_invitations
  ...
  describe 'get_template_invitations test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
