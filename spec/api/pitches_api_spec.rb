...
# Unit tests for CammioAPI::PitchesApi
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'PitchesApi' do
  before do
  ...
  describe 'test an instance of PitchesApi' do
    it 'should create an instance of PitchesApi' do
      expect(@api_instance).to be_instance_of(CammioAPI::PitchesApi)
    end
  end

  # unit tests for get_pitch
  # Get a pitch by ID
  # This resource returns the details of a pitch. 
  # @param pitch_id ID of the pitch
  # @param [Hash] opts the optional parameters
  # @return [Pitch]
  describe 'get_pitch test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for get_pitches
  # List all pitches
