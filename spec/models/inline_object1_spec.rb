...
# Unit tests for CammioAPI::InlineObject1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'InlineObject1' do
  before do
    # run before each test
    @instance = CammioAPI::InlineObject1.new
  end
  ...
  describe 'test an instance of InlineObject1' do
    it 'should create an instance of InlineObject1' do
      expect(@instance).to be_instance_of(CammioAPI::InlineObject1)
    end
  end
  ...
  describe 'test attribute "callback_params"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
