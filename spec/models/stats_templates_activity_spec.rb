...
# Unit tests for CammioAPI::StatsTemplatesActivity
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'StatsTemplatesActivity' do
  before do
    # run before each test
    @instance = CammioAPI::StatsTemplatesActivity.new
  end
  ...
  describe 'test an instance of StatsTemplatesActivity' do
    it 'should create an instance of StatsTemplatesActivity' do
      expect(@instance).to be_instance_of(CammioAPI::StatsTemplatesActivity)
    end
  end
