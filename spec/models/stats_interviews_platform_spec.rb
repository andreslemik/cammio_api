...
# Unit tests for CammioAPI::StatsInterviewsPlatform
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'StatsInterviewsPlatform' do
  before do
    # run before each test
    @instance = CammioAPI::StatsInterviewsPlatform.new
  end
  ...
  describe 'test an instance of StatsInterviewsPlatform' do
    it 'should create an instance of StatsInterviewsPlatform' do
      expect(@instance).to be_instance_of(CammioAPI::StatsInterviewsPlatform)
    end
  end
