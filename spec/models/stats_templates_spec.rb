...
# Unit tests for CammioAPI::StatsTemplates
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'StatsTemplates' do
  before do
    # run before each test
    @instance = CammioAPI::StatsTemplates.new
  end
  ...
  describe 'test an instance of StatsTemplates' do
    it 'should create an instance of StatsTemplates' do
      expect(@instance).to be_instance_of(CammioAPI::StatsTemplates)
    end
  end
