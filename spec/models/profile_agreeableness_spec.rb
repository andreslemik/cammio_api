...
# Unit tests for CammioAPI::ProfileAgreeableness
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'ProfileAgreeableness' do
  before do
    # run before each test
    @instance = CammioAPI::ProfileAgreeableness.new
  end
  ...
  describe 'test an instance of ProfileAgreeableness' do
    it 'should create an instance of ProfileAgreeableness' do
      expect(@instance).to be_instance_of(CammioAPI::ProfileAgreeableness)
    end
  end
