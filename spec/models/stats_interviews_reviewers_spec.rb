...
# Unit tests for CammioAPI::StatsInterviewsReviewers
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'StatsInterviewsReviewers' do
  before do
    # run before each test
    @instance = CammioAPI::StatsInterviewsReviewers.new
  end
  ...
  describe 'test an instance of StatsInterviewsReviewers' do
    it 'should create an instance of StatsInterviewsReviewers' do
      expect(@instance).to be_instance_of(CammioAPI::StatsInterviewsReviewers)
    end
  end
