...
# Unit tests for CammioAPI::ProfileExtraversion
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'ProfileExtraversion' do
  before do
    # run before each test
    @instance = CammioAPI::ProfileExtraversion.new
  end
  ...
  describe 'test an instance of ProfileExtraversion' do
    it 'should create an instance of ProfileExtraversion' do
      expect(@instance).to be_instance_of(CammioAPI::ProfileExtraversion)
    end
  end
