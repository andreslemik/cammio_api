...
# Unit tests for CammioAPI::KillerQuestion
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'KillerQuestion' do
  before do
    # run before each test
    @instance = CammioAPI::KillerQuestion.new
  end
  ...
  describe 'test an instance of KillerQuestion' do
    it 'should create an instance of KillerQuestion' do
      expect(@instance).to be_instance_of(CammioAPI::KillerQuestion)
    end
  end
