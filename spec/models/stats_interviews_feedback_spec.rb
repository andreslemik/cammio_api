...
# Unit tests for CammioAPI::StatsInterviewsFeedback
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'StatsInterviewsFeedback' do
  before do
    # run before each test
    @instance = CammioAPI::StatsInterviewsFeedback.new
  end
  ...
  describe 'test an instance of StatsInterviewsFeedback' do
    it 'should create an instance of StatsInterviewsFeedback' do
      expect(@instance).to be_instance_of(CammioAPI::StatsInterviewsFeedback)
    end
  end
