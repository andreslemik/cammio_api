...
# Unit tests for CammioAPI::ProfileOpenness
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'ProfileOpenness' do
  before do
    # run before each test
    @instance = CammioAPI::ProfileOpenness.new
  end
  ...
  describe 'test an instance of ProfileOpenness' do
    it 'should create an instance of ProfileOpenness' do
      expect(@instance).to be_instance_of(CammioAPI::ProfileOpenness)
    end
  end
