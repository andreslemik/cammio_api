...
# Unit tests for CammioAPI::Interviewer
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'Interviewer' do
  before do
    # run before each test
    @instance = CammioAPI::Interviewer.new
  end
  ...
  describe 'test an instance of Interviewer' do
    it 'should create an instance of Interviewer' do
      expect(@instance).to be_instance_of(CammioAPI::Interviewer)
    end
  end
