...
# Unit tests for CammioAPI::ProfileConscientiousness
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'ProfileConscientiousness' do
  before do
    # run before each test
    @instance = CammioAPI::ProfileConscientiousness.new
  end
  ...
  describe 'test an instance of ProfileConscientiousness' do
    it 'should create an instance of ProfileConscientiousness' do
      expect(@instance).to be_instance_of(CammioAPI::ProfileConscientiousness)
    end
  end
