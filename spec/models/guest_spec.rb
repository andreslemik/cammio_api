...
# Unit tests for CammioAPI::Guest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'Guest' do
  before do
    # run before each test
    @instance = CammioAPI::Guest.new
  end
  ...
  describe 'test an instance of Guest' do
    it 'should create an instance of Guest' do
      expect(@instance).to be_instance_of(CammioAPI::Guest)
    end
  end
