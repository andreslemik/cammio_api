...
# Unit tests for CammioAPI::InvitationsCallbackParams
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'InvitationsCallbackParams' do
  before do
    # run before each test
    @instance = CammioAPI::InvitationsCallbackParams.new
  end
  ...
  describe 'test an instance of InvitationsCallbackParams' do
    it 'should create an instance of InvitationsCallbackParams' do
      expect(@instance).to be_instance_of(CammioAPI::InvitationsCallbackParams)
    end
  end
  describe 'test attribute "my_custom_param"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "my_other_param"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
