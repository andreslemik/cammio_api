...
# Unit tests for CammioAPI::InlineObject4
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'InlineObject4' do
  before do
    # run before each test
    @instance = CammioAPI::InlineObject4.new
  end
  ...
  describe 'test an instance of InlineObject4' do
    it 'should create an instance of InlineObject4' do
      expect(@instance).to be_instance_of(CammioAPI::InlineObject4)
    end
  end
  ...
  describe 'test attribute "type"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["automated", "live", "pitch"])
