...
# Unit tests for CammioAPI::ProfileConscientiousnessFacets
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'ProfileConscientiousnessFacets' do
  before do
    # run before each test
    @instance = CammioAPI::ProfileConscientiousnessFacets.new
  end
  ...
  describe 'test an instance of ProfileConscientiousnessFacets' do
    it 'should create an instance of ProfileConscientiousnessFacets' do
      expect(@instance).to be_instance_of(CammioAPI::ProfileConscientiousnessFacets)
    end
  end
  describe 'test attribute "driven"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "cautiousness"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "dutifullness"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "orderliness"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "self_discipline"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "self_efficacy"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
