...
# Unit tests for CammioAPI::Answer
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'Answer' do
  before do
    # run before each test
    @instance = CammioAPI::Answer.new
  end
  ...
  describe 'test an instance of Answer' do
    it 'should create an instance of Answer' do
      expect(@instance).to be_instance_of(CammioAPI::Answer)
    end
  end
  ...
  describe 'test attribute "hls_url"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "dash_url"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
