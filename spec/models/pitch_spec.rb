...
# Unit tests for CammioAPI::Pitch
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'Pitch' do
  before do
    # run before each test
    @instance = CammioAPI::Pitch.new
  end
  ...
  describe 'test an instance of Pitch' do
    it 'should create an instance of Pitch' do
      expect(@instance).to be_instance_of(CammioAPI::Pitch)
    end
  end
  ...
  describe 'test attribute "invite_hash"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
