...
# Unit tests for CammioAPI::StatsInterviewsForwarded
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'StatsInterviewsForwarded' do
  before do
    # run before each test
    @instance = CammioAPI::StatsInterviewsForwarded.new
  end
  ...
  describe 'test an instance of StatsInterviewsForwarded' do
    it 'should create an instance of StatsInterviewsForwarded' do
      expect(@instance).to be_instance_of(CammioAPI::StatsInterviewsForwarded)
    end
  end
