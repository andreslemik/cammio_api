...
# Unit tests for CammioAPI::ProfileNeuroticism
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'ProfileNeuroticism' do
  before do
    # run before each test
    @instance = CammioAPI::ProfileNeuroticism.new
  end
  ...
  describe 'test an instance of ProfileNeuroticism' do
    it 'should create an instance of ProfileNeuroticism' do
      expect(@instance).to be_instance_of(CammioAPI::ProfileNeuroticism)
    end
  end
