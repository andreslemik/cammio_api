...
# Unit tests for CammioAPI::Interview
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'Interview' do
  before do
    # run before each test
    @instance = CammioAPI::Interview.new
  end
  ...
  describe 'test an instance of Interview' do
    it 'should create an instance of Interview' do
      expect(@instance).to be_instance_of(CammioAPI::Interview)
    end
  end
  ...
  describe 'test attribute "still_url"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
