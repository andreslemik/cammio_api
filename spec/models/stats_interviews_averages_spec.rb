...
# Unit tests for CammioAPI::StatsInterviewsAverages
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'StatsInterviewsAverages' do
  before do
    # run before each test
    @instance = CammioAPI::StatsInterviewsAverages.new
  end
  ...
  describe 'test an instance of StatsInterviewsAverages' do
    it 'should create an instance of StatsInterviewsAverages' do
      expect(@instance).to be_instance_of(CammioAPI::StatsInterviewsAverages)
    end
  end
