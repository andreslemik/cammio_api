...
# Unit tests for CammioAPI::ProfileNeuroticismFacets
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'ProfileNeuroticismFacets' do
  before do
    # run before each test
    @instance = CammioAPI::ProfileNeuroticismFacets.new
  end
  ...
  describe 'test an instance of ProfileNeuroticismFacets' do
    it 'should create an instance of ProfileNeuroticismFacets' do
      expect(@instance).to be_instance_of(CammioAPI::ProfileNeuroticismFacets)
    end
  end
  describe 'test attribute "fiery"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "anxiety"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "melancholy"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "self_indulgence"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "self_consciousness"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "sensitivity_to_stress"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
