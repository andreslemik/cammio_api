...
# Unit tests for CammioAPI::StatsInterviewsCandidates
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'StatsInterviewsCandidates' do
  before do
    # run before each test
    @instance = CammioAPI::StatsInterviewsCandidates.new
  end
  ...
  describe 'test an instance of StatsInterviewsCandidates' do
    it 'should create an instance of StatsInterviewsCandidates' do
      expect(@instance).to be_instance_of(CammioAPI::StatsInterviewsCandidates)
    end
  end
  ...
  describe 'test attribute "invited"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
